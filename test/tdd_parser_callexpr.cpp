...
TEST(TDD_PARSER_CALL_EXPR, ARGUMENT_MULTIPLE)
{
	...
	// sub 1
	ASSERT_EQ(MCC_AST_EXPRESSION_TYPE_BINARY_OP, call->arguments->expressions[0]->type);

	// sub 2
	ASSERT_EQ(MCC_AST_EXPRESSION_TYPE_LITERAL, call->arguments->expressions[1]->type);
