...
TEST(TDD_PARSER_SYMTABLINK, TEST_FUNC_RETURN3){

const char str[] = "int f(){ int b; b=2; int r; r=1; return r+b;  }  void main(){ int b; b=2; int r; r=f(b); return;  }";
auto result = mCc_parser_parse_string(str);
...
ASSERT_STREQ(idb->id_value,prog->func_defs[1]->body->compound_stmts[1]->id_assgn->symtab_ref->identifier->id_value);
ASSERT_STREQ(idb->id_value,prog->func_defs[0]->body->compound_stmts[4]->ret_val->rhs->identifier->symtab_ref->identifier->id_value);
ASSERT_STREQ(idr->id_value,prog->func_defs[0]->body->compound_stmts[4]->ret_val->lhs->identifier->symtab_ref->identifier->id_value);
ASSERT_STREQ(idr->id_value,prog->func_defs[1]->body->compound_stmts[3]->id_assgn->symtab_ref->identifier->id_value);
ASSERT_STREQ(idf->id_value,prog->func_defs[1]->body->compound_stmts[3]->rhs_assgn->f_name->symtab_ref->identifier->id_value);
...
TEST(TDD_PARSER_SYMTABLINK, TEST_FUNC_RETURN4){

const char str[] = "int f(){ int b; b=2; return 3+2;  }  void main(){ int b; b=2; int r; r=f(b); return;  }";
auto result = mCc_parser_parse_string(str);
...
TEST(TDD_PARSER_SYMTABLINK, TEST_FUNC_RETURN5){

const char str[] = "int f(){ int b; b=2; int r; r=1; return 3+r;  }  void main(){ int b; b=2; int r; r=f(b); return;  }";
auto result = mCc_parser_parse_string(str);
...
ASSERT_STREQ(idb->id_value,prog->func_defs[1]->body->compound_stmts[1]->id_assgn->symtab_ref->identifier->id_value);
ASSERT_STREQ(idr->id_value,prog->func_defs[0]->body->compound_stmts[4]->ret_val->rhs->identifier->symtab_ref->identifier->id_value);
ASSERT_STREQ(idr->id_value,prog->func_defs[1]->body->compound_stmts[3]->id_assgn->symtab_ref->identifier->id_value);
ASSERT_STREQ(idf->id_value,prog->func_defs[1]->body->compound_stmts[3]->rhs_assgn->f_name->symtab_ref->identifier->id_value);
...
TEST(TDD_PARSER_SYMTABLINK, TEST_FUNC_RETURN6){

const char str[] = "int f(){ int r; r=1; return -r;  }  void main(){ int b; b=2; int r; r=f(b); return;  }";
auto result = mCc_parser_parse_string(str);
...
ASSERT_STREQ(idb->id_value,prog->func_defs[1]->body->compound_stmts[1]->id_assgn->symtab_ref->identifier->id_value);
ASSERT_STREQ(idr->id_value,prog->func_defs[0]->body->compound_stmts[2]->ret_val->unary_expression->identifier->symtab_ref->identifier->id_value);
ASSERT_STREQ(idr->id_value,prog->func_defs[1]->body->compound_stmts[3]->id_assgn->symtab_ref->identifier->id_value);
ASSERT_STREQ(idf->id_value,prog->func_defs[1]->body->compound_stmts[3]->rhs_assgn->f_name->symtab_ref->identifier->id_value);
...
TEST(TDD_PARSER_SYMTABLINK, TEST_FUNC_RETURN7){

const char str[] = "int g(){ int a; return a;} int f(){ return g();  }  int main(){ int b; b=2; int r; r=f(b);return ;  }";
auto result = mCc_parser_parse_string(str);
...
mCc_ast_symtab_build(prog);
mCc_ast_identifier *idb= mCc_ast_new_identifier((char*)"b");
mCc_ast_identifier *idg= mCc_ast_new_identifier((char*)"g");

ASSERT_STREQ(idb->id_value,prog->func_defs[2]->body->compound_stmts[1]->id_assgn->symtab_ref->identifier->id_value);
ASSERT_STREQ(idg->id_value,prog->func_defs[1]->body->compound_stmts[0]->ret_val->f_name->symtab_ref->identifier->id_value);

mCc_ast_delete_identifier(idb);
mCc_ast_delete_identifier(idg);
